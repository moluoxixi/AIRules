...
- [ ] `design.md` includes Layout, Fields, Components, States, and Frontend Test Matrix
- [ ] Fields table has no unresolved `MISSING blocked:` row for UI-required fields
- [ ] Every UI unit has a component decision: `existing`, `wrap existing`, or `new`

| Gate | Result | Evidence |
|---|---|---|
| Layout present | PASS / FAIL | — |
| Fields complete | PASS / FAIL | — |
| Components classified | PASS / FAIL | — |
| States covered | PASS / FAIL | — |
| Frontend Test Matrix present | PASS / FAIL | — |

If any UI-required field remains `MISSING blocked:`, Overall Decision MUST be FAIL.

---

## 6. Frontend Verification Evidence

| Test Layer | Command / Evidence | Exit Status | Desktop | Mobile | Console / Network | Result |
|---|---|---|---|---|---|---|
| Unit | — | — | N/A | N/A | N/A | PASS / FAIL / NOT RUN automated / MISSING blocked |
| Component | — | — | N/A | N/A | N/A | PASS / FAIL / NOT RUN automated / MISSING blocked |
| Integration | — | — | N/A | N/A | — | PASS / FAIL / NOT RUN automated / MISSING blocked |
| E2E / Browser | — | — | — | — | — | PASS / FAIL / NOT RUN automated / MISSING blocked |
| Visual / Responsive Smoke | — | — | — | — | — | PASS / FAIL / NOT RUN automated / MISSING blocked |

Missing project tooling must be recorded as `MISSING blocked: no frontend test runner`
or `NOT RUN automated: <reason>`. Do not infer PASS from manual inspection alone.
...
## 8. Front-Door Routing Leak Detector（warning,非阻塞）
