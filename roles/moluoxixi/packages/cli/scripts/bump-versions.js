#!/usr/bin/env node
/**
 * Bump @moluoxixi/airules-moluoxixi and @mindfoldhq/moluoxixi-core to the same next
...
function main() {
  ...
  process.stderr.write(
    `${GREEN}ok${RESET} bumped @moluoxixi/airules-moluoxixi and @mindfoldhq/moluoxixi-core (${type}) -> ${next}\n`,
  );
