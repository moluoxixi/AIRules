...
/**
 * Check if a Moluoxixi update is available (compare project version with CLI version)
 */
...
program
  ...
  .option(
    "--with-statusline",
    "Install the Moluoxixi statusLine for Claude Code (off by default)",
  )
...
program
  .command("upgrade")
  .description("Upgrade the global Moluoxixi CLI package")
  .option(
    "--tag <tag>",
