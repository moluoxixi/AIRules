/**
 * Migration types for Moluoxixi update command
 *
 ...
 *
 * Used by `moluoxixi update` to append the section to existing user config files
...
export interface ConfigSectionAdded {
  /** Target file relative to project root (e.g. `.moluoxixi/config.yaml`). */
  file: string;
  /**
