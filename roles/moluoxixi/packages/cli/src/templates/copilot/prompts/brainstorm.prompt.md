---
description: "Guide requirements discovery for a Moluoxixi task after task-creation consent."
---
...
```bash
TASK_DIR=$({{PYTHON_CMD}} ./.moluoxixi/scripts/task.py create "<short task title>" --description "<one-line summary>" --slug <slug>)
```
