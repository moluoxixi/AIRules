...
- Raw platform conversation stores queryable via `moluoxixi mem`: `~/.claude/projects/`, `~/.codex/sessions/`, OpenCode's local SQLite store, and `~/.pi/agent/sessions/`.
