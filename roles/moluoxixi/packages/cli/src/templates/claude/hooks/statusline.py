...
# -*- coding: utf-8 -*-
"""
Moluoxixi StatusLine — project-level status display for Claude Code.

Reads Claude Code session JSON from stdin + Moluoxixi task data from filesystem.
Outputs 1-2 lines:
