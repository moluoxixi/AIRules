#!/usr/bin/env python3
"""
Standalone reader for .moluoxixi/config.yaml.

Owns the minimal YAML parser used across Moluoxixi. ``common.config`` imports
...
CONFIG_REL_PATH = ".moluoxixi/config.yaml"
