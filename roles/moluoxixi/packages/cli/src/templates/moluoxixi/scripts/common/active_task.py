...
The user-facing concept is a single "active task". Moluoxixi stores that pointer
per AI session/window under `.moluoxixi/.runtime/sessions/`; without a stable
...
def _relative_task_ref(task_path: str, repo_root: Path) -> str:
    ...
    # symlinked `.moluoxixi` (#567) maps back to its in-repo form; anything
