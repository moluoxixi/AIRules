...
```bash
python3 ./.moluoxixi/scripts/get_context.py --mode phase --step <X.X> --platform omp
```
...
Full workflow, skill routing table, and the DO-NOT-skip table live in `.moluoxixi/workflow.md`. This command is only an entry point — the canonical guidance is there.
