...
| `moluoxixi-implement` | Implement against `prd.md`, `info.md`, `implement.jsonl`, and related spec/research. |
...
Main-session workflow platforms such as Kilo, Antigravity, and Windsurf may not have Moluoxixi sub-agent files. They usually rely on workflows/skills to guide the main session.
