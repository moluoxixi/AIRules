...
| agents | `.claude/agents/`, `.codex/agents/`, `.kiro/agents/` | Define agents such as `moluoxixi-research`, `moluoxixi-implement`, and `moluoxixi-check`. |
...
- generated `.moluoxixi/runtime/` dependencies
