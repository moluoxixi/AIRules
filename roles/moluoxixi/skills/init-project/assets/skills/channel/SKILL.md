...
- Long-term memory retrieval. Use durable forum channels for actionable issues, and `node "<skill-root>/scripts/trellis.mjs" mem` (the `session-insight` skill) for session/history search.
