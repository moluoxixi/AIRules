...
This page lists common Trellis file locations in a user project by platform. Whether a platform directory exists in an actual project depends on which `init-project --platform <id>` selections the user ran.
