...
This directory is for an AI working in a project initialized by the `init-project` skill. Modify generated `.moluoxixi/` and platform directories inside the project; do not install or edit an upstream Trellis package.
