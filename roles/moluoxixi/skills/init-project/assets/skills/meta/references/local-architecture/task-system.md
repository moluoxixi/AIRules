...
The Trellis task system is stored entirely under `.moluoxixi/tasks/` in the user project. Each task is a directory containing requirements, context, research, state, and relationship information.
...
```bash
python3 ./.moluoxixi/scripts/task.py create "<child title>" --slug <child-slug> --parent <parent-dir>
```
...
```bash
python3 ./.moluoxixi/scripts/task.py create "<title>" --slug <slug>
