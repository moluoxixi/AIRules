...
Trellis connects the same local architecture to different AI tools. `.moluoxixi/` stores the shared runtime; platform directories store adapter files that define how each AI tool enters Trellis.
