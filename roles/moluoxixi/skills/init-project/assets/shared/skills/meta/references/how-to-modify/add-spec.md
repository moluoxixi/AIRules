...
|------|--------|----------|
| `.moluoxixi/spec/mobile/index.md` | Create | Yes |
| `.moluoxixi/spec/mobile/*.md` | Create | Yes |
| Task JSONL templates | Update | Yes |
| `project-local/SKILL.md` | Update | Yes |
...
Create `.moluoxixi/spec/mobile/index.md`:
...
def init_mobile_context(task_dir):
    ...
    with open(jsonl_path, "a") as f:
        f.write(json.dumps({
            "file": ".moluoxixi/spec/mobile/index.md",
...
```jsonl
{"file": ".moluoxixi/spec/mobile/index.md", "reason": "Mobile guidelines"}
{"file": ".moluoxixi/spec/mobile/architecture.md", "reason": "Architecture patterns"}
```

---

## Step 5: Document in project-local
