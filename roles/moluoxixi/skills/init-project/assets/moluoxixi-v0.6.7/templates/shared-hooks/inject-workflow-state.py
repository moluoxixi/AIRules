...
If you have not already loaded Moluoxixi context this session, read the `moluoxixi-start` skill once.
</moluoxixi-bootstrap>"""
...
def main() -> int:
    ...
    if task is None:
        ...
        # moluoxixi-brainstorm + task.py create when user describes real work.
