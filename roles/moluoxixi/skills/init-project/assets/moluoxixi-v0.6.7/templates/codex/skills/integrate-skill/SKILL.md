...
description: "Adapts an external skill into project-specific development guidelines in .moluoxixi/spec/. Creates guideline sections, code example templates with .template suffix, and updates spec indexes. Use when integrating an external skill, adding a new skill's patterns to project conventions, or incorporating third-party skill best practices into .moluoxixi/spec/ documentation."
---
