...
const TASK_PATH = '.moluoxixi/tasks/00-bootstrap-guidelines/task.json'
const PRD_PATH = '.moluoxixi/tasks/00-bootstrap-guidelines/prd.md'
...
const DEFAULT_NOTES = /^First-time setup task created by moluoxixi init \((backend|frontend|fullstack|unknown) project\)$/u
...
export function localizeBootstrapTask({ project, enabled = true } = {}) {
  ...
  task.notes = `由 moluoxixi init 创建的首次初始化任务（${PROJECT_TYPE_LABELS[noteMatch[1]]}）`
