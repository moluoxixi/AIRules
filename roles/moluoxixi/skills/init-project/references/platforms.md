...
The initializer always creates the shared `.trellis/` runtime, root managed instructions, project specs, workspace index, task root, and local Trellis license notices.
