...
This page lists common Trellis file locations in a user project by platform. Whether a platform directory exists in an actual project depends on which `the `init-project` skill --<platform>` commands the user ran.
...
5. User wants Trellis behavior: edit `.moluoxixi/workflow.md` plus platform hooks/agents/skills/commands.
