...
node "${HOME}/.moluoxixi/scripts/host-setup.mjs" --host codex --mode upgrade --home "${HOME}/.moluoxixi"
```
...
node "$env:USERPROFILE\\.moluoxixi\\scripts\\host-setup.mjs" --host codex --mode upgrade --home "$env:USERPROFILE\\.moluoxixi"
```
