...
- `sync` refreshes selected remote assets, projects canonical skills, runs selected role setup commands, and projects selected role MCP declarations where a host has an MCP contract.
