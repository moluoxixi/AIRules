...
| 代理 (Host) | 投影方式 | 引导文件 |
|-------|-------------------|---------------|
| **Claude Code** | 软链接至 `~/.claude/` | `CLAUDE.md` |
| **Codex** | 软链接至 `~/.codex/` | `AGENTS.md` |
| **Cursor** | 软链接至 `~/.cursor/` | `AGENTS.md` |
| **Qoder** | 软链接至 `~/.qoder/` | `AGENTS.md` |
| **Tare** | 软链接至 `~/.tare/` | `AGENTS.md` |
| **OpenCode** | 软链接至 `~/.config/opencode/` | `AGENTS.md` |
| **CC-Switch** | 软链接至 `~/.cc-switch/` | `AGENTS.md` |
