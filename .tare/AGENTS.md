# Moluoxixi Tare Skills Layer

## Installed Surface

When tare is installed from this repository, treat these paths as the active host-facing surface:
...
- `.tare/AGENTS.md` is the tare-specific guidance file in this repository
...
- Start from the installed namespace at `~/.agents/skills/moluoxixi/`.
