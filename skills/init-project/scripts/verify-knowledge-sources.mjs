...
function main(args) {
  if (args.length === 0)
    throw new Error('Usage: node skills/init-project/scripts/verify-knowledge-sources.mjs [--evidence] <json-file> [...]')

  if (args[0] === '--evidence') {
    const evidenceFiles = args.slice(1)
    if (evidenceFiles.length === 0)
      throw new Error('Usage: node skills/init-project/scripts/verify-knowledge-sources.mjs --evidence <evidence-json> [...]')
