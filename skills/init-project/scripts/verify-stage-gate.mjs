#!/usr/bin/env node
// 链式前置门禁的确定性校验器。
// 用法：node skills/init-project/scripts/verify-stage-gate.mjs <project-root> <stage> <module>
...
if (!projectRootArg || !stageArg || !moduleArg) {
  console.error('用法：node skills/init-project/scripts/verify-stage-gate.mjs <project-root> <stage> <module>')
