...
function verifySelf() {
  ...
  assertContains(skill, /模块统一/, 'SKILL.md 必须覆盖模块系统统一')
  assertContains(skill, /ESM/, 'SKILL.md 必须覆盖 ESM')
  assertContains(skill, /CommonJS/, 'SKILL.md 必须覆盖 CommonJS')
  assertContains(skill, /NodeNext/, 'SKILL.md 必须覆盖 TypeScript NodeNext 解析策略')
  assertContains(skill, /Dual Package Hazard/, 'SKILL.md 必须覆盖 Dual Package Hazard 风险')
  ...
  assertContains(skill, /顶层模块注册/, 'SKILL.md 必须覆盖 entrypoint 顶层模块注册')
  assertContains(skill, /transport-module` 暴露注册函数/, 'SKILL.md 必须覆盖模块级路由注册函数')
  ...
  assertContains(skill, /Pino|Winston/, 'SKILL.md 必须覆盖结构化日志库')
  ...
  assertContains(skill, /## 测试边界/, 'SKILL.md 必须包含测试边界 section')
