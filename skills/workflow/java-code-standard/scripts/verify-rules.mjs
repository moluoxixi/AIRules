...
function verifySelf() {
  ...
  assertContains(skill, /ApplicationEvent/, 'SKILL.md 必须覆盖跨聚合领域事件')
  assertContains(skill, /@TransactionalEventListener/, 'SKILL.md 必须覆盖事务事件监听')
  ...
  assertContains(skill, /业务唯一键/, 'SKILL.md 必须覆盖 JPA Entity equals/hashCode 业务唯一键')
