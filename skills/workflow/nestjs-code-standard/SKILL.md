...
### 2.1 输入防污染与查询边界 (Payload Pollution & Query Boundary)
...
### 2.2 序列化边界 (Default Deny Serialization)
...
### 2.3 事务防腐层 (Transaction Anti-Corruption Layer)
...
### 2.5 鉴权授权与租户边界 (Auth & Tenant Isolation)
...
### 2.6 配置与错误映射 (Config & Error Mapping)
