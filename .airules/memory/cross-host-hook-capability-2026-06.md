...
**决策状态**：能力基线（本条事实）已落 [ADR-0006](../../.airules/knowledge/架构/decisions/ADR-0006-cross-host-hook-capability-baseline.md) 第一段；其第二段「PreToolUse 阻断边界」已于 2026-06-29 经仓库维护者批准转 `accepted`，loop-guard / subagent-trace 已据此立项落地（边界细节见 [[pretooluse-block-only-three-signals]]、[[hook-never-block-stop-events]]）。
