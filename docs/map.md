...
| components | [组件库文档索引](components/index.md) | 记录组件库文档入口；具体组件库文档由 components-docs 生成或更新。 |
...
- 架构文档放入 `docs/architecture/`，接口文档放入 `docs/api/`，需求文档放入 `docs/prds/`，测试文档放入 `docs/test/`，组件库文档放入 `docs/components/`。
