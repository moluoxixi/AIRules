...
The historical non-merge commit reconciliation from `v0.6.7` through `v0.6.15` is recorded in [history/reconciliation-v0.6.15.json](history/reconciliation-v0.6.15.json).
